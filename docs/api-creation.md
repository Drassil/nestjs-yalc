...
- **All the examples below are contained in `platform-kit/sk-module` folder available in this repo.** It's a fully working module that you can import in your system to test it.
